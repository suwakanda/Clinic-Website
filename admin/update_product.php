...
if(isset($_POST['update'])){
   ...
   $image_folder_01 = '../assets/img/product/'.$image_01;
   ...
   if(!empty($image_01)){
      if($image_size_01 > 2000000){
         ...
         unlink('../assets/img/product/'.$old_image_01);
   ...
   $image_folder_02 = '../assets/img/product/'.$image_02;
   ...
   if(!empty($image_02)){
      if($image_size_02 > 2000000){
         ...
         unlink('../assets/img/product/'.$old_image_02);
   ...
   $image_folder_03 = '../assets/img/product/'.$image_03;
   ...
   if(!empty($image_03)){
      if($image_size_03 > 2000000){
         ...
         unlink('../assets/img/product/'.$old_image_03);
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="image-container">
         <div class="main-image">
            <img src="../assets/img/product/<?= $fetch_products['image_01']; ?>" alt="">
         </div>
         <div class="sub-image">
            
            <?php if (!empty($fetch_products['image_01'])){?>
               <img src="../assets/img/product/<?= $fetch_products['image_01']; ?>" alt=""><?php } ?>

               <?php if (!empty($fetch_products['image_02'])){?>
               <img src="../assets/img/product/<?= $fetch_products['image_02']; ?>" alt=""><?php } ?>
               
               <?php if (!empty($fetch_products['image_03'])){?>
               <img src="../assets/img/product/<?= $fetch_products['image_03']; ?>" alt=""> <?php } ?>
            </div>
         </div>
      </div>
      ...
      <div class="inputBox">
         <span>CATEGORY (require):</span>
            ...
            <option value="testingkit">testing kit</option>
            </select>
      </div>
