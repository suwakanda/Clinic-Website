        ...
        <div class="container-fluid">
				...
				<div class="w-100 d-flex">
					...
					<div class="col-3">
						<select id="w_selected" class="custom-select select" >
							...
							<option value="disable">Mark as Disable</option>
			...
			<table class="table table-bordered table-stripped" id="indi-list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * From `article`   ");
...
<script>
	...
	$(document).ready(function(){
		$('.view_data').click(function(){
			uni_modal("Article Details","article/view_details.php?id="+$(this).attr('data-id'))
		})
		$('#create_new').click(function(){
			uni_modal("Article Form","article/manage_article.php",'mid-large')
		})
		$('.edit_data').click(function(){
			uni_modal("Edit Article Details","article/manage_article.php?id="+$(this).attr('data-id'),'mid-large')
		})
    ...
    $(function(){
		...
		$('#selected_go').click(function(){
			...
			$.ajax({
				url:_base_url_+'classes/Master.php?f=multiple_action_article',
				method:"POST",
