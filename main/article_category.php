      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="row">
                  ...
                  $search = $_POST["search"];
                  $select_article = $conn->prepare("SELECT * FROM `article` WHERE `isActive` = 0 AND category = '$category' AND title like '%$search%' OR  category like'%$search%h' OR author like'%$search%' OR article like'%$search%'
                  ");
                ...
                $category = $_GET['category'];
                $select_article = $conn->prepare("SELECT * FROM `article` WHERE `isActive` = 0 And category = ? "); 
                $select_article->execute([$category]);}
